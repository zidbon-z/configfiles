...
if [ -d $HOME/.config/configfiles/arch-hyprland ]; then
  echo "Setting up symbolic links to config files"

  # Symlink newsboat
  if [ -d "$HOME/.config/configfiles/arch-hyprland/home/newsboat" ]; then
  ...
  # Symlink hyprland
  if [ -d "$HOME/.config/configfiles/arch-hyprland/bspwm" ]; then
  ...
  # Symlink ranger
  if [ -d "$HOME/.config/configfiles/arch-hyprland/ranger" ]; then
  ...
  # Symlink kitty
  if [ -d "$HOME/.config/configfiles/arch-hyprland/kitty" ]; then
  ...
  # Symlink Neovim
  if [ -d "$HOME/.config/configfiles/arch-hyprland/nvim" ]; then
  ...
  # Symlink Waybar
  if [ -d "$HOME/.config/configfiles/arch-hyprland/waybar" ]; then
  ...
  # Symlink Waypaper
  if [ -d "$HOME/.config/configfiles/arch-hyprland/waypaper" ]; then
  ...
  if [ -d "$HOME/.config/configfiles/arch-hyprland/hypr" ]; then
  ...
  # Symlink zshrc
  if [ -f "$HOME/.config/configfiles/arch-hyprland/zsh/.zshrc" ]; then
  ...
  # Symlink wofi
  if [ -d "$HOME/.config/configfiles/arch-hyprland/wofi" ]; then
